export const photos = {
  hero: '/pattern-h/user-hero-cherry.webp',
  guests: '/pattern-h/user-guests-kiyomizu.webp',
  don: '/pattern-h/user-don-fushimi.webp',
  culture: '/kyoto/nijo-castle.jpg',
  fushimi: '/pattern-h/user-don-fushimi.webp',
  nijo: '/kyoto/nijo-castle.jpg',
  lane: '/pattern-h/user-hero-cherry.webp',
  garden: '/kyoto/fushimi-inari.jpg',
  tea: '/pattern-h/user-hero-cherry.webp',
  food: '/pattern-h/user-guests-kiyomizu.webp',
  autumn: '/pattern-h/user-hero-cherry.webp',
  shrine: '/pattern-h/user-guests-kiyomizu.webp',
  alley: '/pattern-h/user-hero-cherry.webp',
};
